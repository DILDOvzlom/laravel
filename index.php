...
`                            <h2 class="art-PostHeaderIcon-wrapper">
                                ...
                                <span class="art-PostHeader">САЙТ ПЕРВАЯ СТРАНИЦА</span>
                            </h2>
                            <div class="art-PostContent">


<p align="justify"><b>ЭТО МОЙ ПРОЕКТ ПО  LARAVEL </p>

<p align="justify">Выполнили: Мамонов Роман, Игорь Винник</p>
...
<p align="justify">
                                ...
                                <p>
                                	<span class="art-button-wrapper">
                                		<span class="l"> </span>
                                		<span class="r"> </span>
                                		<a class="art-button" href="javascript:void(0)">Читать дальше...</a>
                                	</span>
                                </p>
                        ...
                        <div class="art-Post-inner">
                            <h2 class="art-PostHeaderIcon-wrapper">
                                <img src="res/images/welcome.jpg" width="9" height="9" alt="PostHeaderIcon" />
                                <span class="art-PostHeader">Первая история: ЖИЛ БЫЛ ГЕНА</span>
                            </h2>
                            <div class="art-PostContent">
